...
public class RotatingObstacle extends Obstacle{
	...
	public void update() {
		...
		if(!collisioned) {
			angle+=this.rotationSpeed/(16.66/frameTime);
	...
	public double[] getBox() {
		...
		transform.rotate(angle);
		Point2D.Double tip = new Point2D.Double(-width/2, -height/2);
		Point2D.Double tip2 = new Point2D.Double(width/2, height/2);
	...
	public int[] getVertices() {
		...
		Point2D.Double tip = new Point2D.Double(-width/2, -height/2);
		Point2D.Double tip2 = new Point2D.Double(width/2, -height/2);
		Point2D.Double tip3 = new Point2D.Double(-width/2, height/2);
		Point2D.Double tip4 = new Point2D.Double(width/2, height/2);
	    transform.transform(tip, tip);
	    transform.transform(tip2, tip2);
	...
	public void appendCollision(double x, double y, boolean selector) {
		...
		Point2D.Double tip = new Point2D.Double(x, y);
	    transform.transform(tip, tip);
		Point2D.Double center = new Point2D.Double(this.x+width/2, this.y+height-20);
